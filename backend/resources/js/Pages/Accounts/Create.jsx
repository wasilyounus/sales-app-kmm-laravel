    ...
    return (
        <AdminLayout title="Create Account">
            ...
            <div className="flex items-center gap-4 mb-6">
                <Link
                    href="/admin/accounts"
                    className="inline-flex items-center justify-center w-10 h-10 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 transition-colors"
                >
                ...
                <div>
                    <p className="text-gray-600">Add a new business account to your system</p>
                </div>
            </div>
